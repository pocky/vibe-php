...
namespace App\Tests\Blog\Unit\Application\Operation\Query\Author\GetAuthor;

use App\Blog\Application\Operation\Query\GetAuthor\Handler;
use App\Blog\Application\Operation\Query\GetAuthor\Query;
use App\Blog\Application\Operation\Query\GetAuthor\View;
...
final class HandlerTest extends TestCase
{
    ...
    public function testHandleGetAuthorSuccess(): void
    {
        ...
        $author = \App\Blog\Domain\Author\CreateAuthor\Model\Author::create(
            ...
            new \App\Blog\Domain\Shared\ValueObject\AuthorBio('A passionate writer'),
