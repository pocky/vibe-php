...
namespace App\Tests\Blog\Unit\Application\Operation\Query\Author\ListAuthors;

use App\Blog\Application\Operation\Query\ListAuthors\Handler;
use App\Blog\Application\Operation\Query\ListAuthors\Query;
use App\Blog\Application\Operation\Query\ListAuthors\View;
...
{
    private AuthorReadRepositoryInterface&MockObject $repository;

    private Handler $handler;

    protected function setUp(): void
    {
        $this->repository = $this->createMock(AuthorReadRepositoryInterface::class);
    ...
    public function testHandleListAuthorsSuccess(): void
    {
        ...
        $author1 = \App\Blog\Domain\Author\CreateAuthor\Model\Author::create(
            ...
            new \App\Blog\Domain\Shared\ValueObject\AuthorBio('Bio 1'),
            new \DateTimeImmutable('2024-01-15')
        );

        $author2 = \App\Blog\Domain\Author\CreateAuthor\Model\Author::create(
            new \App\Blog\Domain\Shared\ValueObject\AuthorId('660e8400-e29b-41d4-a716-446655440001'),
            ...
            new \App\Blog\Domain\Shared\ValueObject\AuthorBio('Bio 2'),
