...
/**
 * Maps SubmitForReview domain objects to Doctrine entities
 */
final readonly class SubmitForReviewMapper implements ArticleMapperInterface
{
    #[\Override]
    ...
    public function mapToEntity(object $article, BlogArticle|null $existingEntity = null): BlogArticle
    {
        ...
        if (!$existingEntity instanceof BlogArticle) {
            throw new \RuntimeException(sprintf('Cannot submit article %s for review: entity not found', $article->getArticleId()->getValue()));
        }
